...
/*   Updated: 2024/02/28 11:27:17 by asalo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static char	*initialize(char *stash, int *eol)
{
	size_t	i;
	char	*line;
...
static size_t	find_eol(char *line)
{
	size_t	i;
...
static char	*extract(char *line, char *stash, int *eol, int fd)
{
